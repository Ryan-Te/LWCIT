...
class CPUFP
{
	...
	internal static GameObject createCube(float X, float Z)
		{
	...
	internal static GameObject createCube(float X, float Y, float Z)
		{
	...
	internal static GameObject createCube(float X, float Z,Color C)
	{
		//Create the container game object, and activate it
		var obj = new GameObject();
		obj.SetActive(true);
	...
	internal static GameObject createCube(float X, float Y, float Z, Color C)
	{
	...
	internal static Vector3 getPegPos(float sizeX, float sizeZ, string Side)
		{
			Vector3 Output;
			if (Side == "F")
			{
	...
	internal static Vector3 getPegPos(float sizeX, float sizeY, float sizeZ, string Side)
		{
			Vector3 Output;
			if (Side == "F")
			{
	...
	internal static Vector3 getPegPos(float sizeX, float sizeZ, string Side, float offsetX, float offsetY)
	{
		Vector3 Output;
		if (Side == "F")
		{
		...
		{
			Output = new Vector3(-0.3f * offsetX, 0.15f + (offsetY * 0.3f), -0.15f * sizeX + 0.04f);
		...
		{
			Output = new Vector3(offsetX * 0.3f, 0.15f + (offsetY * 0.3f), 0.15f * sizeX - 0.04f);
		}
		else if (Side == "R")
		{
	...
	internal static Vector3 getPegPos(float sizeX, float sizeY, float sizeZ, string Side, float offsetX, float offsetY)
	{
		Vector3 Output;
		if (Side == "F")
		{
